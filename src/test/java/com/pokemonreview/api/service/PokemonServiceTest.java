...
public class PokemonServiceTest {
    ...
    @Test
    public void PokemonService_GetAllPokemon_ReturnMoreThanOnePokemonDto() {
    ...
    @Test
    public void PokemonService_GetAllPokemonById_ReturnPokemonDto() {
        Pokemon pokemon = Pokemon.builder()
                .name("pickachu")
                .type("electric")
                .build();
    ...
    @Test
    public void PokemonService_UpdatePokemon_ReturnNotNullPokemonDto() {
        Pokemon pokemon = Pokemon.builder()
                .name("pickachu")
                .type("electric")
                .build();
    ...
    @Test
    public void PokemonService_DeletePokemonById_ReturnPokemonIsEmpty() {
        Pokemon pokemon = Pokemon.builder()
                .name("pickachu")
                .type("electric")
                .build();
